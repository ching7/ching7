...
| 仓库 | 点评 | ⭐ | 语言 | 最后更新 |
| --- | --- | --- | --- | --- |
| [ching7/ppt2video](https://github.com/ching7/ppt2video) | PPT 转 MP4 小工具，TTS + FFmpeg 拼出来的，意外多人 star | 35 | Java | 1 天前 |
...
| [ching7/ai-roundtable](https://github.com/ching7/ai-roundtable) | Chrome 扩展，实现真正的 AI 圆桌会议。还支持让单个 AI 扮演多个内置角色自我互评 | 1 | JavaScript | 1 天前 |
...
_Last updated by GitHub Action · 2026-06-04_
<!--END_SECTION:footer-->
</content>
