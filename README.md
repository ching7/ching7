...
| 仓库 | 点评 | ⭐ | 语言 | 最后更新 |
| --- | --- | --- | --- | --- |
| [ching7/ppt2video](https://github.com/ching7/ppt2video) | PPT 转 MP4 小工具，TTS + FFmpeg 拼出来的，意外多人 star | 38 | Java | 3 个月前 |
| [ching7/prompt-me](https://github.com/ching7/prompt-me) | 一个基于福格行为模型（B=MAP）的行为操作系统，通过记录、提示、分析和AI教练，帮助用户把目标变成持续行动，最终形成习惯与自律 | 1 | JavaScript | 2 个月前 |
| [ching7/ai-roundtable](https://github.com/ching7/ai-roundtable) | Chrome 扩展，实现真正的 AI 圆桌会议。还支持让单个 AI 扮演多个内置角色自我互评 | 1 | JavaScript | 3 个月前 |
...
_Last updated by GitHub Action · 2026-09-06_
<!--END_SECTION:footer-->
</content>
