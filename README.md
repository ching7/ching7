...
| [ching7/prompt-me](https://github.com/ching7/prompt-me) | 一个基于福格行为模型（B=MAP）的行为操作系统，通过记录、提示、分析和AI教练，帮助用户把目标变成持续行动，最终形成习惯与自律 | 1 | JavaScript | 3 天前 |
...
_Last updated by GitHub Action · 2026-06-18_
<!--END_SECTION:footer-->
</content>
